...
train_loader = DataLoader(N_MNIST('./N-MNIST-Refactored/', True), batch_size=1, shuffle=False)
test_loader = DataLoader(N_MNIST('./N-MNIST-Refactored/', False), batch_size=1, shuffle=False)
